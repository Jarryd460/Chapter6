...
public class testWard {
    ...
    public void setUp() {
        ...
        ward1 = new Ward.Builder(1).capacity(20).patients(patientList1).build();
        ward2 = new Ward.Builder(2).capacity(23).patients(patientList2).build();
        ward3 = ward1;
    }

    @Test
    public void testWardId() {
        Assert.assertEquals(1, ward1.getId());
    }
