...
public class testRadiologist {
    ...
    public void setUp() {
        ...
        Radiologist1 = new Radiologist.Builder(1).firstName("Oliver").lastName("Khan").appointments(appointmentList1).build();
        Radiologist2 = new Radiologist.Builder(2).firstName("Ronald").lastName("Macdonald").appointments(appointmentList2).build();
        Radiologist3 = Radiologist1;
    }

    @Test
    public void testSurgeonId() {
        Assert.assertEquals(1, Radiologist1.getId());
    }
