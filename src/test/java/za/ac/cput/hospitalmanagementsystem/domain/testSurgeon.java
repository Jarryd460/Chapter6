...
public class testSurgeon {
    ...
    public void setUp() {
        ...
        surgeon1 = new Surgeon.Builder(1).firstName("Oliver").lastName("Khan").appointments(appointmentList1).build();
        surgeon2 = new Surgeon.Builder(2).firstName("Ronald").lastName("Macdonald").appointments(appointmentList2).build();
        surgeon3 = surgeon1;
    }

    @Test
    public void testSurgeonId() {
        Assert.assertEquals(1, surgeon1.getId());
    }
